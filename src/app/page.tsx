    ...
    <main className="flex min-h-screen flex-col items-center p-8
      ...
      <section className="projects-container grid sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3
        ...
        <ProjectCard>
          ...
          <br />
          <p>
            A bug tracker webapp written with Next.js. The backend is a Postgres database
            with Prisma models to interface between the backend and frontend. This project 
            is actively being worked on, so some features may not be present yet or may be 
            buggy. Please feel free to reach out with issues/suggestions! 
          </p>
          <br />
          <a href="https://bugtracker.keithaustin.dev/" 
